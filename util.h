...
int cmp_node_runjob(int sock_han,struct tx_struct *data);
int cmp_addnode(int sock_han,struct tx_struct *data);
int cmp_rxfile(int sock_han,struct tx_struct *data);
...
int cmp_runjobs(int sock_han,struct tx_struct *data);
